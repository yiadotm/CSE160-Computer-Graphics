...
class Vector3 {
  ...
  static dot(other1, other2) {
      // Insert your code here.
      let element1 = other1.elements[0] * other2.elements[0];
      let element2 = other1.elements[1] * other2.elements[1];
      let element3 = other1.elements[2] * other2.elements[2];

      let d = (element1 + element2 + element3); // Modify this line to calculate this vector's magnitude.
      // Don't delete the return statement.
      return d;
  }
  ...
  magnitude() {
      // Insert your code here.
      let element1 = this.elements[0] * this.elements[0];
      let element2 = this.elements[1] * this.elements[1];
      let element3 = this.elements[2] * this.elements[2];
      let m = Math.sqrt(element1 + element2 + element3);
      // Don't delete the return statement.
      return m;
  };
